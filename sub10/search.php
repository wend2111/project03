	...
	<div id="Contentwrap" class="cf">
		<div id="localGnb">
			<div class="localGnbInner cf">
				<div class="gnb">
					...
					<span class="gt"></span>
					<a href="board_form.php">게시판</a>
					<span class="gt"></span>
					<a href="board_form.php" class="active">게시판 목록보기</a>
				</div>
				<div class="shareArea">
					<ul>
		...
		<div class="contentWrapInner cf">
			...
			<div id="sub5Content1" class="cf">
				<div id="noticeBoard">
					<h3 class="noticeBoardTit">게시판 목록</h3>
					<div class="boardSearchForm">
						<form method="get" action="search.php">						
							<div class="rowTableSearch cf">
								...
								<select name="catgo" id="categorySearch2" class="categorySearch2 fl">
									<option value="subject">제목</option>
									<option value="name">작성자</option>
									<option value="content">내용</option>
								</select>	
								<input type="text" value="검색" name="search" class="search1 guidetext fl"/>	
