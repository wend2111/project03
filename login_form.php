...
<head>
	...
	<title>회원가입 : 부산광역시</title>
	<link rel="stylesheet" href="sub8/css/comm_layout.css"/>	
	<link rel="stylesheet" href="sub8/css/sub8.css"/>
	<link rel="shortcut icon" href="../images/favicon.ico" type="image/x-icon"/>
	<link rel="icon" href="../images/favicon.ico" type="image/x-icon"/>
	<script src="js/jquery-1.9.1.min.js"></script>
	<script src="js/login.js"></script>
	<script src="sub8/js/guidetext.js"></script>	
	<script src="sub8/js/script.js"></script>
</head>
<body>
	<div id="headerWrap">
		<div class="header">
	...
	<div id="Contentwrap" class="cf">
		<div id="localGnb">
			<div class="localGnbInner cf">
				<div class="gnb">
					...
					<span class="gt"></span>
					<a href="https://www.busan.go.kr/opgfaq" class="active">회원가입</a>
				</div>
				<div class="shareArea">
					<ul>
		...
		<div class="contentWrapInner cf">
			...
			<div id="sub6Content1" class="cf">
				<h3 class="noticeBoardTit">로그인</h3>			
				<div class="tab">
					<ul class="cf">
				...
				<div class="tabContent cf">
					<div class="loginBox">
						<form class="loginForm" name="login_form" method="post" action="login.php">
							<fieldset>	
								<legend>Member Loin</legend>
								<div class="login">
									<p>
										<!-- <label for="userId" class="labelStyle"></label> -->
										<input type="text" name="id" id="userId" class="guidetext" value="admin"/>
									</p>
									<p>
										<!-- <label for="userPWD" class="labelStyle"></label> -->
										<input type="password" name="pass" id="userPWD"  class="guidetext" value="1234"/>
									</p>
									<p>
								...
								<p class="btnTitle">아이디 / 비밀번호가 기억나지 않으세요?</p>
								<p class="btn2">
									<input type="button" value="아이디 찾기" class="btnJoin" />
									<input type="button" value="비밀번호 재발급" class="btnSearch" />
								</p>
							</fieldset>
						</form>					
					</div>
					<div class="joinWrap">
						...
						<p class="text1">회원 로그인 시 마일리지 적립, 이벤트 참여 등의 혜택이 있습니다.</p>
						<p class="text2">시 대표 포털에 회원가입 하시면 패밀리사이트에 동시에 가입되며, 가입된 통합 아이디로 패밀리사이트에서 동시에 사용 가능합니다.</p>
						<div class="btnWrap">
							<p class="btn2">
								<input type="button" value="회원가입" class="btnJoin" onclick="location.href='member_form.php'"/>
								<input type="button" value="패밀리 사이트 보기" class="btnSearch" />
							</p>							
						</div>
					</div>
					<div class="security">
						<p class="securityTitle"><span class="securityImg1"></span><span class="colorBlue">키보드보안</span>프로그램 설치</p>
						<p>키보드로 입력되는 정보가 유출되거나 변조되지 않도록 보호해주는 프로그램입니다.<br/>설치하지 않으셔도 홈페이지 이용에 아무런 지장이 없으나 보다 안전한 개인정보 보호를 위해 설치를 권장합니다.</p>
						<p class="small">※키보드보안(TouchEN KEY) 관련문의 : 라온시큐어 ☎1644-4128</p>
					</div>
					<button class="securityBtn"><span class="securityImg2"></span><span class="lihgt">설치하기</span></button>
				</div>
			</div><!-- id="sub1Content1" -->
