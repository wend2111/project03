...
?>
	...
	<div id="headerWrap">
		<div class="header">
			<div id="mainLogo"><a href="index.php" class="showBalloon" title="부산로고"><img src="images/main_logo.png" width="215" height="60" alt="메인로고"/><h1>부산로고</h1></a></div><!-- id="mainLogo" -->
			<div id="mainGnb">
				<h2>메인 GNB</h2>
				<ul>									
					<li class="loginCnt">
...
?>				
				<ul>	
					<li><?=$logged?> </li>
						<form>
							<input type="submit" class="button1" value="로그아웃" onclick="location.href='logout_form.php'">
							<input type="submit" class="button2 cf" value="정보수정" onclick="location.href='member_modify_form.php'">
						</form>
						<span class="loginCntText">자동 로그아웃</span><span id="counter"></span> <input type="button" class="button3" value="연장" onclick="counter_reset()">
				</ul>
<?php
